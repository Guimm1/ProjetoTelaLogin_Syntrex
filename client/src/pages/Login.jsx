...
import Syntrex from "../images/SyntrexB.png"
    ...
    <div>
      <Container className="justify-content-center align-content-center min-vh-100">
        ...
        <Row className="bg-primary">
          ...
          <Col>
            {/* ícone de login */}
            <img src={Syntrex} alt="Logo da Syntrex" style={{ width: "600px" }} />
          ...
          <Col className="d-flex flex-column">
            <Form 
              ...
              <Button
                ...
                className="mb-5"
                size="lg"
                style={{ backgroundColor: "#28a745", borderColor: "#28a745" }} // verde customizado
